...
Option_v__ast__ConstField v__ast__Scope_find_const(v__ast__Scope* s, string name);
...
bool v__checker__is_expr_panic_or_exit(v__ast__Expr expr);
...
void v__gen__Gen_generate_array_equality_fn(v__gen__Gen* g, string ptr_typ, v__table__Type styp, v__table__TypeSymbol* sym);
...
char * v_typeof_sumtype_86(int sidx) { /* v.table.TypeInfo */ 
	switch(sidx) {
		case 86: return "v.table.TypeInfo";
		case 77: return "v.table.Array";
		case 78: return "v.table.ArrayFixed";
		case 79: return "v.table.Map";
		case 80: return "v.table.Struct";
		case 81: return "v.table.MultiReturn";
		case 82: return "v.table.Alias";
		case 83: return "v.table.Enum";
		case 84: return "v.table.SumType";
		case 85: return "v.table.FnType";
		default: return "unknown v.table.TypeInfo";
	}
}
char * v_typeof_sumtype_104(int sidx) { /* v.ast.Stmt */ 
	switch(sidx) {
		case 104: return "v.ast.Stmt";
		case 162: return "v.ast.GlobalDecl";
		case 107: return "v.ast.FnDecl";
		case 163: return "v.ast.Return";
		case 164: return "v.ast.Module";
		case 165: return "v.ast.Import";
		case 166: return "v.ast.ExprStmt";
		case 167: return "v.ast.ForStmt";
		case 168: return "v.ast.StructDecl";
		case 169: return "v.ast.ForCStmt";
		case 170: return "v.ast.ForInStmt";
		case 171: return "v.ast.CompIf";
		case 172: return "v.ast.ConstDecl";
		case 173: return "v.ast.Attr";
		case 174: return "v.ast.BranchStmt";
		case 175: return "v.ast.HashStmt";
		case 176: return "v.ast.AssignStmt";
		case 177: return "v.ast.EnumDecl";
		case 128: return "v.ast.TypeDecl";
		case 178: return "v.ast.DeferStmt";
		case 179: return "v.ast.GotoLabel";
		case 180: return "v.ast.GotoStmt";
		case 181: return "v.ast.Comment";
		case 182: return "v.ast.AssertStmt";
		case 183: return "v.ast.UnsafeStmt";
		case 184: return "v.ast.GoStmt";
		case 185: return "v.ast.Block";
		case 186: return "v.ast.InterfaceDecl";
		default: return "unknown v.ast.Stmt";
	}
}
char * v_typeof_sumtype_128(int sidx) { /* v.ast.TypeDecl */ 
	switch(sidx) {
		case 128: return "v.ast.TypeDecl";
		case 125: return "v.ast.AliasTypeDecl";
		case 126: return "v.ast.SumTypeDecl";
		case 127: return "v.ast.FnTypeDecl";
		default: return "unknown v.ast.TypeDecl";
	}
}
char * v_typeof_sumtype_161(int sidx) { /* v.ast.Expr */ 
	switch(sidx) {
		case 161: return "v.ast.Expr";
		case 129: return "v.ast.InfixExpr";
		case 130: return "v.ast.IfExpr";
		case 131: return "v.ast.StringLiteral";
		case 132: return "v.ast.IntegerLiteral";
		case 133: return "v.ast.CharLiteral";
		case 134: return "v.ast.FloatLiteral";
		case 135: return "v.ast.Ident";
		case 136: return "v.ast.CallExpr";
		case 137: return "v.ast.BoolLiteral";
		case 138: return "v.ast.StructInit";
		case 139: return "v.ast.ArrayInit";
		case 140: return "v.ast.SelectorExpr";
		case 141: return "v.ast.PostfixExpr";
		case 142: return "v.ast.AssignExpr";
		case 143: return "v.ast.PrefixExpr";
		case 144: return "v.ast.IndexExpr";
		case 145: return "v.ast.RangeExpr";
		case 146: return "v.ast.MatchExpr";
		case 147: return "v.ast.CastExpr";
		case 148: return "v.ast.EnumVal";
		case 149: return "v.ast.Assoc";
		case 150: return "v.ast.SizeOf";
		case 151: return "v.ast.None";
		case 152: return "v.ast.MapInit";
		case 153: return "v.ast.IfGuardExpr";
		case 154: return "v.ast.ParExpr";
		case 155: return "v.ast.OrExpr";
		case 156: return "v.ast.ConcatExpr";
		case 157: return "v.ast.Type";
		case 158: return "v.ast.AsCast";
		case 159: return "v.ast.TypeOf";
		case 160: return "v.ast.StringInterLiteral";
		default: return "unknown v.ast.Expr";
	}
}
char * v_typeof_sumtype_189(int sidx) { /* v.ast.ScopeObject */ 
	switch(sidx) {
		case 189: return "v.ast.ScopeObject";
		case 187: return "v.ast.ConstField";
		case 162: return "v.ast.GlobalDecl";
		case 188: return "v.ast.Var";
		default: return "unknown v.ast.ScopeObject";
	}
}
char * v_typeof_sumtype_201(int sidx) { /* v.ast.IdentInfo */ 
	switch(sidx) {
		case 201: return "v.ast.IdentInfo";
		case 199: return "v.ast.IdentFn";
		case 200: return "v.ast.IdentVar";
...
multi_return_v__pref__Preferences_string parse_args(array_string args) {
	v__pref__Preferences* res = (v__pref__Preferences*)memdup(&(v__pref__Preferences){	.os = {0},
		...
		.mod = tos3(""),
		.run_args = new_array(0, 1, sizeof(string)),
...
inline
v__table__MultiReturn v__table__TypeSymbol_mr_info(v__table__TypeSymbol* t) {
	if (t->info.typ == 81 /* v.table.MultiReturn */) {
...
inline
v__table__Array v__table__TypeSymbol_array_info(v__table__TypeSymbol* t) {
	if (t->info.typ == 77 /* v.table.Array */) {
...
inline
v__table__ArrayFixed v__table__TypeSymbol_array_fixed_info(v__table__TypeSymbol* t) {
	if (t->info.typ == 78 /* v.table.ArrayFixed */) {
...
bool v__table__Table_has_cflag(v__table__Table* table, v__builder__CFlag cflag) {
	// FOR IN
	for (int tmp1 = 0; tmp1 < table->cflags.
	len; tmp1++) {	v__builder__CFlag cf = ((v__builder__CFlag*)table->cflags.
	data)[tmp1];if (string_eq(cf.os, cflag.os) && string_eq(cf.name, cflag.name) && string_eq(cf.value, cflag.value)) {
			return true;
		}
	}
	return false;
...
Option_bool v__table__Table_parse_cflag(v__table__Table* table, string cflag, string mod, array_string ctimedefines) {
	...
	// FOR IN
	for (int tmp3 = 0; tmp3 < allowed_os_overrides.
	len; tmp3++) {	string os_override = ((string*)allowed_os_overrides.
	data)[tmp3];if (!string_starts_with(flag, os_override)) {
			continue;
		}
	...
	while (1) {
		...
		if (string_at(flag, 0) == '-') {
			// FOR IN
			for (int tmp6 = 0; tmp6 < allowed_flags.
			len; tmp6++) {	string f = ((string*)allowed_flags.
			data)[tmp6];int i = 1 + f.len;
		...
		while (/*opt*/(*(int*)index.data) > -1) {
			bool has_next = false;
			// FOR IN
			for (int tmp8 = 0; tmp8 < allowed_flags.
			len; tmp8++) {	string f = ((string*)allowed_flags.
			data)[tmp8];int i = /*opt*/(*(int*)index.data) + 2 + f.len;
		...
		if (!v__table__Table_has_cflag(table, cf)) {
			_PUSH(&table->cflags, (cf), tmp15, v__builder__CFlag);
		}
		if (/*opt*/(*(int*)index.data) == -1) {
			break;
		}
...
Option_v__table__Field v__table__TypeSymbol_find_field(v__table__TypeSymbol* s, string name) {
	if (s->info.typ == 80 /* v.table.Struct */) {
...
int v__table__Table_find_or_register_map(v__table__Table* t, v__table__Type key_type, v__table__Type value_type) {
	...
	}}, sizeof(v__table__Map)), .typ = 79 /* v.table.Map */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_array(v__table__Table* t, v__table__Type elem_type, int nr_dims) {
	...
	v__table__TypeSymbol array_type = (v__table__TypeSymbol){
		...
		.elem_type = elem_type,
		.nr_dims = nr_dims,
	}}, sizeof(v__table__Array)), .typ = 77 /* v.table.Array */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_array_fixed(v__table__Table* t, v__table__Type elem_type, int size, int nr_dims) {
	...
	v__table__TypeSymbol array_fixed_type = (v__table__TypeSymbol){
		...
		.size = size,
		.nr_dims = nr_dims,
	}}, sizeof(v__table__ArrayFixed)), .typ = 78 /* v.table.ArrayFixed */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_multi_return(v__table__Table* t, array_v__table__Type mr_typs) {
	...
	v__table__TypeSymbol mr_type = (v__table__TypeSymbol){
		...
		.types = mr_typs,
		.name = tos3(""),
	}}, sizeof(v__table__MultiReturn)), .typ = 81 /* v.table.MultiReturn */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
...
int v__table__Table_find_or_register_fn_type(v__table__Table* t, v__table__Fn f, bool has_decl) {
	...
	return v__table__Table_register_type_symbol(t, (v__table__TypeSymbol){
		...
		.has_decl = has_decl,
		.func = f,
	}}, sizeof(v__table__FnType)), .typ = 85 /* v.table.FnType */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
}
...
array_string v__doc__Doc_get_fn_signatures(v__doc__Doc d, v__doc__FilterFn filter_fn) {
	...
	data)[tmp1];if (stmt.typ == 107 /* v.ast.FnDecl */) {
...
string v__util__formatted_error(string kind, string emsg, string filepath, v__token__Position pos) {
	...
	array_string source_lines = string_split_into_lines(/*opt*/(*(string*)source.data));
	...
	string position = _STR("%.*s:%d:%d:", path.len, path.str, pos.line_nr + 1, v__util__imax(1, column + 1));
	int bline = v__util__imax(0, pos.line_nr - _const_v__util__error_context_before);
	int aline = v__util__imin(source_lines.len - 1, pos.line_nr + _const_v__util__error_context_after);
	array_string clines = new_array(0, 0, sizeof(string));
	string tab_spaces = tos3("    ");
	for (int iline = bline;
	iline <= aline; iline++) {
		string sline = (*(string*)array_get(source_lines, iline));
		string cline = string_add(_STR("%5d| ", iline + 1), string_replace(sline, tos3("\t"), tab_spaces));
		if (iline == pos.line_nr && _const_v__util__emanager->support_color) {
			cline = term__red(cline);
		}
		_PUSH(&clines, (cline), tmp5, string);
		if (iline == pos.line_nr) {
			array_string pointerline = new_array(0, 0, sizeof(string));
			for (int i = 0; i < sline.len; i++) {
			byte c = sline.str[i];
				if (i < column) {
					byte x = c;
					if (x == '\t') {
						_PUSH(&pointerline, (tab_spaces), tmp9, string);
					} else {
						x = (byte_is_space(x) ? c : ' ');
						_PUSH(&pointerline, (byte_str(x)), tmp11, string);
					}
					continue;
				}
				if (pos.len > 1) {
					string underline = string_repeat(tos3("~"), pos.len);
					_PUSH(&pointerline, ((_const_v__util__emanager->support_color ? term__bold(term__blue(underline)) : underline)), tmp13, string);
				} else {
					_PUSH(&pointerline, ((_const_v__util__emanager->support_color ? term__bold(term__blue(tos3("^"))) : tos3("^"))), tmp15, string);
				}
				break;
			}
			_PUSH(&clines, (string_add(tos3("       "), array_string_join(pointerline, tos3("")))), tmp17, string);
		}
	}
	source_context = string_add(source_context, array_string_join(clines, tos3("\n")));
...
void v__util__launch_tool(bool is_verbose, string tool_name) {
	...
	if (is_verbose) {
		println(_STR("launch_tool should_compile: %.*s", should_compile ? 4 : 5, should_compile ? "true" : "false"));
	}
	if (should_compile) {
		...
		if (/*opt*/(*(os__Result*)tool_compilation.data).exit_code != 0) {
			...
			if (!string_contains(/*opt*/(*(os__Result*)tool_compilation.data).output, tos3("Permission denied"))) {
				err = _STR("\n%.*s", /*opt*/(*(os__Result*)tool_compilation.data).output.len, /*opt*/(*(os__Result*)tool_compilation.data).output.str);
			}
			eprintln(_STR("cannot compile ‘%.*s: %.*s‘", tool_source.len, tool_source.str, err.len, err.str));
			v_exit(1);
		}
	}
	if (is_verbose) {
...
Option_string v__util__read_file(string file_path) {
	...
	if (!raw_text.ok) {
		...
		// last_type: v.ast.Return
		// last_expr_result_type: 
		return v_error(_STR("failed to open %.*s", file_path.len, file_path.str));
	};
...
string v__builder__Builder_gen_c(v__builder__Builder* b, array_string v_files) {
	...
	v__builder__Builder_info(/*rec*/*b, _STR("PARSE: %dms", parse_time));
	v__checker__Checker_check_files(&b->checker, b->parsed_files);
	i64 t2 = time__ticks();
	i64 check_time = t2 - t1;
	v__builder__Builder_info(/*rec*/*b, _STR("CHECK: %dms", check_time));
	...
	i64 t3 = time__ticks();
	i64 gen_time = t3 - t2;
	v__builder__Builder_info(/*rec*/*b, _STR("C GEN: %dms", gen_time));
	return res;
}

void v__builder__Builder_build_c(v__builder__Builder* b, array_string v_files, string out_file) {
	b->out_name_c = out_file;
	v__builder__Builder_info(/*rec*/*b, _STR("build_c(%.*s)", out_file.len, out_file.str));
...
void v__builder__Builder_cc(v__builder__Builder* v) {
	...
	if (v->pref->is_verbose) {
		println(_STR("builder.cc() pref.out_name=\"%.*s\"", v->pref->out_name.len, v->pref->out_name.str));
	}
	...
	if (v->pref->is_bare) {
		_PUSH(&a, (tos3("-fno-stack-protector -static -ffreestanding -nostdlib")), tmp19, string);
	}
	...
	if (debug_mode) {
		_PUSH(&a, (debug_options), tmp34, string);
	...
	if (debug_mode && string_ne(os__user_os(), tos3("windows"))) {
		_PUSH(&a, (tos3(" -rdynamic ")), tmp39, string);
	}
	...
	// FOR IN
	for (int tmp42 = 0; tmp42 < v__builder__Builder_generate_hotcode_reloading_compiler_flags(v).
	len; tmp42++) {	string f = ((string*)v__builder__Builder_generate_hotcode_reloading_compiler_flags(v).
	data)[tmp42];_PUSH(&a, (f), tmp43, string);
	}
	string libs = tos3("");
	if (v->pref->build_mode == v__pref__BuildMode_build_module) {
		_PUSH(&a, (tos3("-c")), tmp45, string);
	} else if (v->pref->is_cache) {
	}
	if (v->pref->sanitize) {
		_PUSH(&a, (tos3("-fsanitize=leak")), tmp47, string);
	}
	_PUSH(&a, (_STR("-o \"%.*s\"", v->pref->out_name.len, v->pref->out_name.str)), tmp48, string);
	...
	if (v->pref->os == v__pref__OS_mac) {
		_PUSH(&a, (tos3("-x objective-c")), tmp51, string);
	}
	_PUSH(&a, (_STR("\"%.*s\"", v->out_name_c.len, v->out_name_c.str)), tmp52, string);
	if (v->pref->os == v__pref__OS_mac) {
		_PUSH(&a, (tos3("-x none")), tmp54, string);
	}
	if (v->pref->os == v__pref__OS_mac) {
		_PUSH(&a, (tos3("-mmacosx-version-min=10.7")), tmp56, string);
	}
	if (v->pref->os == v__pref__OS_windows) {
		_PUSH(&a, (tos3("-municode")), tmp58, string);
	}
...
void v__builder__Builder_build_thirdparty_obj_files(v__builder__Builder* c) {
	// FOR IN
	for (int tmp1 = 0; tmp1 < v__builder__Builder_get_os_cflags(c).
	len; tmp1++) {	v__builder__CFlag flag = ((v__builder__CFlag*)v__builder__Builder_get_os_cflags(c).
...
array_v__builder__CFlag v__builder__Builder_get_os_cflags(v__builder__Builder* v) {
	array_v__builder__CFlag flags = new_array(0, 0, sizeof(v__builder__CFlag));
...
string array_v__builder__CFlag_c_options_before_target(array_v__builder__CFlag cflags) {
	...
	data)[tmp1];if (string_ne(flag.name, tos3("-l"))) {
			_PUSH(&args, (v__builder__CFlag_format(&flag)), tmp3, string);
		}
	}
...
void v__builder__compile(string command, v__pref__Preferences* pref) {
	...
	if (pref->backend == v__pref__Backend_x64) {
		_PUSH(&files, (pref->path), tmp3, string);
		...
		_PUSH_MANY(&files, (v__builder__Builder_get_builtin_files(b)), tmp6, array_string);
		_PUSH_MANY(&files, (v__builder__Builder_get_user_files(b)), tmp7, array_string);
		v__builder__Builder_set_module_lookup_paths(&b);
		if (pref->is_verbose) {
...
void v__builder__Builder_run_compiled_executable_and_exit(v__builder__Builder* b) {
	if (b->pref->is_verbose) {
		println(_STR("============ running %.*s ============", b->pref->out_name.len, b->pref->out_name.str));
	}
	string cmd = _STR("\"%.*s\"", b->pref->out_name.len, b->pref->out_name.str);
	// FOR IN
	for (int tmp2 = 0; tmp2 < b->pref->run_args.
	len; tmp2++) {	string arg = ((string*)b->pref->run_args.
	data)[tmp2];if (string_index_byte(arg, ' ') > 0) {
...
void v__builder__Builder_set_module_lookup_paths(v__builder__Builder* v) {
	v->module_search_paths = new_array(0, 0, sizeof(string));
	if (v->pref->is_test) {
		_PUSH(&v->module_search_paths, (os__base_dir(v->compiled_dir)), tmp2, string);
	}
	_PUSH(&v->module_search_paths, (v->compiled_dir), tmp3, string);
...
array_string v__builder__Builder_get_user_files(v__builder__Builder v) {
	...
	v__builder__Builder_log(v, _STR("get_v_files(%.*s)", dir.len, dir.str));
	...
	if (is_internal_module_test) {
		...
		if (v.pref->is_verbose) {
			v__builder__Builder_log(v, _STR("> Compiling an internal module _test.v file %.*s .", single_test_v_file.len, single_test_v_file.str));
	...
	if (is_real_file && (string_ends_with(dir, tos3(".v")) || string_ends_with(dir, tos3(".vsh")))) {
		...
		if (v.pref->is_verbose) {
			v__builder__Builder_log(v, _STR("> just compile one file: \"%.*s\"", single_v_file.len, single_v_file.str));
		}
	} else {
		if (v.pref->is_verbose) {
	...
	if (v.pref->is_verbose) {
		v__builder__Builder_log(v, _STR("user_files: %d", user_files));
	}
	return user_files;
}
...
void v__builder__Builder_cc_msvc(v__builder__Builder* v) {
	...
	_PUSH(&a, (_STR("-I \"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).ucrt_include_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).ucrt_include_path.str)), tmp17, string);
	_PUSH(&a, (_STR("-I \"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).vs_include_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).vs_include_path.str)), tmp18, string);
	_PUSH(&a, (_STR("-I \"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).um_include_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).um_include_path.str)), tmp19, string);
	_PUSH(&a, (_STR("-I \"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).shared_include_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).shared_include_path.str)), tmp20, string);
	...
	_PUSH(&a, (_STR("/LIBPATH:\"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).ucrt_lib_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).ucrt_lib_path.str)), tmp27, string);
	_PUSH(&a, (_STR("/LIBPATH:\"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).um_lib_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).um_lib_path.str)), tmp28, string);
	_PUSH(&a, (_STR("/LIBPATH:\"%.*s\"", /*opt*/(*(v__builder__MsvcResult*)r.data).vs_lib_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).vs_lib_path.str)), tmp29, string);
	...
	string args = array_string_join(a, tos3(" "));
	string cmd = _STR("\"%.*s\" %.*s", /*opt*/(*(v__builder__MsvcResult*)r.data).full_cl_exe_path.len, /*opt*/(*(v__builder__MsvcResult*)r.data).full_cl_exe_path.str, args.len, args.str);
	if (v->pref->is_verbose) {
		println(tos3("\n========== cl cmd line:"));
		println(cmd);
		println(tos3("==========\n"));
...
v__builder__MsvcStringFlags array_v__builder__CFlag_msvc_string_flags(array_v__builder__CFlag cflags) {
	...
	data)[tmp1];if (string_eq(flag.name, tos3("-l"))) {
			...
			_PUSH(&inc_paths, (v__builder__CFlag_format(&flag)), tmp5, string);
...
// TypeDecl
v__ast__IdentVar v__ast__Ident_var_info(v__ast__Ident* i) {
	if (i->info.typ == 200 /* v.ast.IdentVar */) {
...
inline
bool v__ast__expr_is_call(v__ast__Expr expr) {
	return (expr.typ == 136 /* v.ast.CallExpr */) ? true : false;
}
...
void v__ast__Scope_update_var_type(v__ast__Scope* s, string name, v__table__Type typ) {
	if ((*(v__ast__ScopeObject*)map_get3(s->objects, name, &(v__ast__ScopeObject[]){ {0} })).typ == 188 /* v.ast.Var */) {
...
string v__ast__Scope_show(v__ast__Scope* sc, int depth, int max_depth) {
	...
	for (int tmp3 = 0; tmp3 < keys_tmp2.len; tmp3++) {
		...
		if (obj.typ == 187 /* v.ast.ConstField */) {
...
string v__ast__Expr_str(v__ast__Expr x) {
	if (x.typ == 135 /* v.ast.Ident */) {
		v__ast__Ident* it = (v__ast__Ident*)x.obj; // ST it
		return it->name;
	}
	else if (x.typ == 129 /* v.ast.InfixExpr */) {
	...
	else if (x.typ == 143 /* v.ast.PrefixExpr */) {
	...
	else if (x.typ == 134 /* v.ast.FloatLiteral */) {
		v__ast__FloatLiteral* it = (v__ast__FloatLiteral*)x.obj; // ST it
		return it->val;
	}
	else if (x.typ == 131 /* v.ast.StringLiteral */) {
		v__ast__StringLiteral* it = (v__ast__StringLiteral*)x.obj; // ST it
		return _STR("\"%.*s\"", it->val.len, it->val.str);
	}
	else if (x.typ == 160 /* v.ast.StringInterLiteral */) {
		...
		if (it->is_method) {
			return _STR("%.*s.%.*s(%.*s)", v__ast__Expr_str(it->left).len, v__ast__Expr_str(it->left).str, it->name.len, it->name.str, sargs.len, sargs.str);
		}
		return _STR("%.*s.%.*s(%.*s)", it->mod.len, it->mod.str, it->name.len, it->name.str, sargs.len, sargs.str);
	}
	else {
		return _STR("[unhandled expr type %.*s]", tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (x).typ )).len, tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (x).typ )).str);
	}
	;
}
...
string v__ast__CallArg_str(v__ast__CallArg a) {
	if (a.is_mut) {
		return _STR("mut %.*s", v__ast__Expr_str(a.expr).len, v__ast__Expr_str(a.expr).str);
	}
	return _STR("%.*s", v__ast__Expr_str(a.expr).len, v__ast__Expr_str(a.expr).str);
}
...
string v__ast__args2str(array_v__ast__CallArg args) {
	...
	// FOR IN
	for (int tmp1 = 0; tmp1 < args.
	len; tmp1++) {	v__ast__CallArg a = ((v__ast__CallArg*)args.
	data)[tmp1];_PUSH(&res, (v__ast__CallArg_str(a)), tmp2, string);
	}
	return array_string_join(res, tos3(", "));
}

string v__ast__Stmt_str(v__ast__Stmt node) {
	if (node.typ == 176 /* v.ast.AssignStmt */) {
	...
	else if (node.typ == 166 /* v.ast.ExprStmt */) {
		v__ast__ExprStmt* it = (v__ast__ExprStmt*)node.obj; // ST it
		return v__ast__Expr_str(it->expr);
	}
	else if (node.typ == 107 /* v.ast.FnDecl */) {
		v__ast__FnDecl* it = (v__ast__FnDecl*)node.obj; // ST it
		return _STR("fn %.*s() { %d stmts }", it->name.len, it->name.str, it->stmts.len);
	}
	else {
		return _STR("[unhandled stmt str type: %.*s ]", tos3( /* v.ast.Stmt */ v_typeof_sumtype_104( (node).typ )).len, tos3( /* v.ast.Stmt */ v_typeof_sumtype_104( (node).typ )).str);
	}
	;
}
	...
	if (string_starts_with(val, tos3("flag"))) {
		...
		if (string_contains(flag, tos3("@VROOT"))) {
			...
			if (vmod_file_location.vmod_file.len == 0) {
				v__parser__Parser_error(p, string_add(string_add(tos3("To use @VROOT, you need"), _STR(" to have a \"v.mod\" file in %.*s,", p->file_name_dir.len, p->file_name_dir.str)), tos3(" or in one of its parent folders.")));
			}
			flag = string_replace(flag, tos3("@VROOT"), vmod_file_location.vmod_folder);
		}
		// FOR IN
		for (int tmp4 = 0; tmp4 < new_array_from_c_array(4, 4, sizeof(string), (string[4]){
		tos3("@VMOD"), tos3("@VMODULE"), tos3("@VPATH"), tos3("@VLIB_PATH"), 
}).
		len; tmp4++) {	string deprecated = ((string*)new_array_from_c_array(4, 4, sizeof(string), (string[4]){
		tos3("@VMOD"), tos3("@VMODULE"), tos3("@VPATH"), tos3("@VLIB_PATH"), 
}).
		data)[tmp4];if (string_contains(flag, deprecated)) {
				v__parser__Parser_error(p, _STR("%.*s had been deprecated, use @VROOT instead.", deprecated.len, deprecated.str));
			}
		}
		Option_bool tmp6 = v__table__Table_parse_cflag(p->table, flag, p->mod, p->pref->compile_defines_all);
		if (!tmp6.ok) {
			string err = tmp6.v_error;
			int errcode = tmp6.ecode;
			 // typeof it_expr_type: v.ast.CallExpr
...
v__ast__FnDecl v__parser__Parser_fn_decl(v__parser__Parser* p) {
	...
	if (p->tok.kind == v__token__Kind_name) {
		...
		if (is_method && v__table__TypeSymbol_has_method(v__table__Table_get_type_symbol(p->table, rec_type), name)) {
			v__parser__Parser_error(p, _STR("duplicate method `%.*s`", name.len, name.str));
		}
	}
...
v__ast__Stmt v__parser__Parser_top_stmt(v__parser__Parser* p) {
	if (p->tok.kind == v__token__Kind_key_pub) {
		if (p->peek_tok.kind == v__token__Kind_key_const) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ConstDecl[]) {v__parser__Parser_const_decl(p)}, sizeof(v__ast__ConstDecl)), .typ = 172 /* v.ast.ConstDecl */};
		}
		else if (p->peek_tok.kind == v__token__Kind_key_fn) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__FnDecl[]) {v__parser__Parser_fn_decl(p)}, sizeof(v__ast__FnDecl)), .typ = 107 /* v.ast.FnDecl */};
		}
		else if (p->peek_tok.kind == v__token__Kind_key_struct || p->peek_tok.kind == v__token__Kind_key_union) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__StructDecl[]) {v__parser__Parser_struct_decl(p)}, sizeof(v__ast__StructDecl)), .typ = 168 /* v.ast.StructDecl */};
		}
			...
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__EnumDecl[]) {v__parser__Parser_enum_decl(p)}, sizeof(v__ast__EnumDecl)), .typ = 177 /* v.ast.EnumDecl */};
		}
		else if (p->peek_tok.kind == v__token__Kind_key_type) {
			return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__TypeDecl[]) {v__parser__Parser_type_decl(p)}, sizeof(v__ast__TypeDecl)), .typ = 128 /* v.ast.TypeDecl */};
		}
		else {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Attr[]) {v__parser__Parser_attribute(p)}, sizeof(v__ast__Attr)), .typ = 173 /* v.ast.Attr */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GlobalDecl[]) {v__parser__Parser_global_decl(p)}, sizeof(v__ast__GlobalDecl)), .typ = 162 /* v.ast.GlobalDecl */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__CompIf[]) {v__parser__Parser_comp_if(p)}, sizeof(v__ast__CompIf)), .typ = 171 /* v.ast.CompIf */};
	}
	else if (p->tok.kind == v__token__Kind_hash) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__HashStmt[]) {v__parser__Parser_hash(p)}, sizeof(v__ast__HashStmt)), .typ = 175 /* v.ast.HashStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Comment[]) {v__parser__Parser_comment(p)}, sizeof(v__ast__Comment)), .typ = 181 /* v.ast.Comment */};
	}
	else {
...
v__ast__Stmt v__parser__Parser_stmt(v__parser__Parser* p) {
	if (p->tok.kind == v__token__Kind_lcbr) {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Block[]) {(v__ast__Block){
			.stmts = stmts,
		}}, sizeof(v__ast__Block)), .typ = 185 /* v.ast.Block */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__AssertStmt[]) {(v__ast__AssertStmt){
			.expr = expr,
			.pos = assert_pos,
		}}, sizeof(v__ast__AssertStmt)), .typ = 182 /* v.ast.AssertStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__Return[]) {v__parser__Parser_return_stmt(p)}, sizeof(v__ast__Return)), .typ = 163 /* v.ast.Return */};
	}
	else if (p->tok.kind == v__token__Kind_dollar) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__CompIf[]) {v__parser__Parser_comp_if(p)}, sizeof(v__ast__CompIf)), .typ = 171 /* v.ast.CompIf */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__UnsafeStmt[]) {(v__ast__UnsafeStmt){
			.stmts = stmts,
		}}, sizeof(v__ast__UnsafeStmt)), .typ = 183 /* v.ast.UnsafeStmt */};
	}
	else if (p->tok.kind == v__token__Kind_hash) {
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__HashStmt[]) {v__parser__Parser_hash(p)}, sizeof(v__ast__HashStmt)), .typ = 175 /* v.ast.HashStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__DeferStmt[]) {(v__ast__DeferStmt){
			.stmts = stmts,
			.ifdef = tos3(""),
		}}, sizeof(v__ast__DeferStmt)), .typ = 178 /* v.ast.DeferStmt */};
	}
	else if (p->tok.kind == v__token__Kind_key_go) {
		v__parser__Parser_next(p);
		v__ast__Expr expr = v__parser__Parser_expr(p, 0);
		if (expr.typ == 136 /* v.ast.CallExpr */) {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GoStmt[]) {(v__ast__GoStmt){
			.call_expr = expr,
		}}, sizeof(v__ast__GoStmt)), .typ = 184 /* v.ast.GoStmt */};
	}
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__GotoStmt[]) {(v__ast__GotoStmt){
			.name = name,
		}}, sizeof(v__ast__GotoStmt)), .typ = 180 /* v.ast.GotoStmt */};
	}
	else {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ExprStmt[]) {(v__ast__ExprStmt){
			...
			.pos = epos,
			.typ = {0},
		}}, sizeof(v__ast__ExprStmt)), .typ = 166 /* v.ast.ExprStmt */};
	}
	;
}
...
v__ast__AssignExpr v__parser__Parser_assign_expr(v__parser__Parser* p, v__ast__Expr left) {
	...
	if (left.typ == 144 /* v.ast.IndexExpr */) {
	...
	if (p->peek_tok.kind == v__token__Kind_lpar) {
		...
		if ((_IN_MAP(name, p->table->type_idxs) || _IN_MAP(name_w_mod, p->table->type_idxs)) && !((string_eq(name, tos3("C.stat")) || string_eq(name, tos3("C.sigaction"))))) {
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CastExpr[]) {(v__ast__CastExpr){
				...
				.typname = tos3(""),
				.expr_type = {0},
			}}, sizeof(v__ast__CastExpr)), .typ = 147 /* v.ast.CastExpr */};
			p->expr_mod = tos3("");
			return node;
		} else {
			v__ast__CallExpr x = v__parser__Parser_call_expr(p, is_c, mod);
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CallExpr[]) {x}, sizeof(v__ast__CallExpr)), .typ = 136 /* v.ast.CallExpr */};
		}
		...
		return /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StructInit[]) {v__parser__Parser_struct_init(p, false)}, sizeof(v__ast__StructInit)), .typ = 138 /* v.ast.StructInit */};
		...
		return /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__EnumVal[]) {(v__ast__EnumVal){
			...
			.mod = mod,
			.typ = {0},
		}}, sizeof(v__ast__EnumVal)), .typ = 148 /* v.ast.EnumVal */};
	} else {
		v__ast__Ident ident = (v__ast__Ident){
			.value = tos3(""),
			.is_c = 0,
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 135 /* v.ast.Ident */};
	}
	p->expr_mod = tos3("");
	return node;
}
...
v__ast__Expr v__parser__Parser_expr(v__parser__Parser* p, int precedence) {
	...
	if (p->tok.kind == v__token__Kind_name) {
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__EnumVal[]) {v__parser__Parser_enum_val(p)}, sizeof(v__ast__EnumVal)), .typ = 148 /* v.ast.EnumVal */};
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CharLiteral[]) {(v__ast__CharLiteral){
			.val = p->tok.lit,
		}}, sizeof(v__ast__CharLiteral)), .typ = 133 /* v.ast.CharLiteral */};
		v__parser__Parser_next(p);
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__PrefixExpr[]) {v__parser__Parser_prefix_expr(p)}, sizeof(v__ast__PrefixExpr)), .typ = 143 /* v.ast.PrefixExpr */};
	}
		...
		}}, sizeof(v__ast__BoolLiteral)), .typ = 137 /* v.ast.BoolLiteral */};
		v__parser__Parser_next(p);
	}
	else if (p->tok.kind == v__token__Kind_key_match) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__MatchExpr[]) {v__parser__Parser_match_expr(p)}, sizeof(v__ast__MatchExpr)), .typ = 146 /* v.ast.MatchExpr */};
	}
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__ParExpr[]) {(v__ast__ParExpr){
			.expr = node,
		}}, sizeof(v__ast__ParExpr)), .typ = 154 /* v.ast.ParExpr */};
	}
	else if (p->tok.kind == v__token__Kind_key_if) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IfExpr[]) {v__parser__Parser_if_expr(p)}, sizeof(v__ast__IfExpr)), .typ = 130 /* v.ast.IfExpr */};
	}
	else if (p->tok.kind == v__token__Kind_lsbr) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__ArrayInit[]) {v__parser__Parser_array_init(p)}, sizeof(v__ast__ArrayInit)), .typ = 139 /* v.ast.ArrayInit */};
	}
	else if (p->tok.kind == v__token__Kind_key_none) {
		v__parser__Parser_next(p);
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__None[]) {(v__ast__None){
			.foo = 0,
		}}, sizeof(v__ast__None)), .typ = 151 /* v.ast.None */};
	}
		...
		if (string_eq(p->tok.lit, tos3("C"))) {
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__SizeOf[]) {(v__ast__SizeOf){
				...
				.typ = {0},
			}}, sizeof(v__ast__SizeOf)), .typ = 150 /* v.ast.SizeOf */};
		} else {
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__TypeOf[]) {(v__ast__TypeOf){
			.expr = expr,
			.expr_type = {0},
		}}, sizeof(v__ast__TypeOf)), .typ = 159 /* v.ast.TypeOf */};
	}
	else if (p->tok.kind == v__token__Kind_lcbr) {
		v__parser__Parser_next(p);
		if (p->tok.kind == v__token__Kind_string) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__MapInit[]) {v__parser__Parser_map_init(p)}, sizeof(v__ast__MapInit)), .typ = 152 /* v.ast.MapInit */};
		} else {
	...
	while (precedence < v__token__Token_precedence(p->tok)) {
		if (v__token__Kind_is_assign(p->tok.kind)) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__AssignExpr[]) {v__parser__Parser_assign_expr(p, node)}, sizeof(v__ast__AssignExpr)), .typ = 142 /* v.ast.AssignExpr */};
		} else if (p->tok.kind == v__token__Kind_dot) {
			node = v__parser__Parser_dot_expr(p, node);
		} else if (p->tok.kind == v__token__Kind_lsbr) {
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IndexExpr[]) {v__parser__Parser_index_expr(p, node)}, sizeof(v__ast__IndexExpr)), .typ = 144 /* v.ast.IndexExpr */};
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__AsCast[]) {(v__ast__AsCast){
				...
				.pos = pos,
				.expr_type = {0},
			}}, sizeof(v__ast__AsCast)), .typ = 158 /* v.ast.AsCast */};
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__InfixExpr[]) {(v__ast__InfixExpr){
				...
				.left_type = {0},
				.right_type = {0},
			}}, sizeof(v__ast__InfixExpr)), .typ = 129 /* v.ast.InfixExpr */};
			...
			node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__PostfixExpr[]) {(v__ast__PostfixExpr){
				...
				.expr = node,
				.pos = v__token__Token_position(&p->tok),
			}}, sizeof(v__ast__PostfixExpr)), .typ = 141 /* v.ast.PostfixExpr */};
			v__parser__Parser_next(p);
		} else {
			return node;
		}
...
v__ast__IndexExpr v__parser__Parser_index_expr(v__parser__Parser* p, v__ast__Expr left) {
	...
	if (p->tok.kind == v__token__Kind_dotdot) {
		...
		0},
			...
			.has_high = true,
			.has_low = 0,
		}}, sizeof(v__ast__RangeExpr)), .typ = 145 /* v.ast.RangeExpr */},
			.left_type = {0},
			.is_setter = 0,
		};
	}
...
v__ast__Expr v__parser__Parser_dot_expr(v__parser__Parser* p, v__ast__Expr left) {
	...
	if (p->tok.kind == v__token__Kind_lpar) {
		...
		v__ast__Expr node = (v__ast__Expr){
		0};
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__CallExpr[]) {mcall_expr}, sizeof(v__ast__CallExpr)), .typ = 136 /* v.ast.CallExpr */};
		if (is_filter) {
			v__parser__Parser_close_scope(p);
		}
		return node;
	...
	v__ast__Expr node = (v__ast__Expr){
	0};
	node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__SelectorExpr[]) {sel_expr}, sizeof(v__ast__SelectorExpr)), .typ = 140 /* v.ast.SelectorExpr */};
	if (is_filter) {
		v__parser__Parser_close_scope(p);
	}
	return node;
...
v__ast__Stmt v__parser__Parser_for_stmt(v__parser__Parser* p) {
	...
	if (p->tok.kind == v__token__Kind_lcbr) {
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForStmt[]) {(v__ast__ForStmt){
			...
			.is_inf = true,
			.cond = {0},
		}}, sizeof(v__ast__ForStmt)), .typ = 167 /* v.ast.ForStmt */};
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForCStmt[]) {(v__ast__ForCStmt){
			...
			.inc = inc,
			.pos = pos,
		}}, sizeof(v__ast__ForCStmt)), .typ = 169 /* v.ast.ForCStmt */};
		...
		return /* sum type cast */ (v__ast__Stmt) {.obj = memdup(&(v__ast__ForInStmt[]) {(v__ast__ForInStmt){
			...
			.cond_type = {0},
			.kind = {0},
		}}, sizeof(v__ast__ForInStmt)), .typ = 170 /* v.ast.ForInStmt */};
	}
	v__ast__Expr cond = v__parser__Parser_expr(p, 0);
	p->inside_for = false;
	array_v__ast__Stmt stmts = v__parser__Parser_parse_block(p);
	...
	while ((p->tok.kind == v__token__Kind_key_if || p->tok.kind == v__token__Kind_key_else)) {
		...
		if (p->peek_tok.kind == v__token__Kind_decl_assign) {
			...
			cond = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IfGuardExpr[]) {(v__ast__IfGuardExpr){
				...
				.expr = expr,
				.expr_type = {0},
			}}, sizeof(v__ast__IfGuardExpr)), .typ = 153 /* v.ast.IfGuardExpr */};
		} else {
			cond = v__parser__Parser_expr(p, 0);
		}
		p->inside_if = false;
...
v__ast__Expr v__parser__Parser_string_expr(v__parser__Parser* p) {
	...
	if (p->peek_tok.kind != v__token__Kind_str_dollar) {
		...
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StringLiteral[]) {(v__ast__StringLiteral){
			...
			.is_c = is_cstr,
			.pos = pos,
		}}, sizeof(v__ast__StringLiteral)), .typ = 131 /* v.ast.StringLiteral */};
		return node;
	}
	array_v__ast__Expr exprs = new_array(0, 0, sizeof(v__ast__Expr));
	...
	node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__StringInterLiteral[]) {(v__ast__StringInterLiteral){
		...
		.pos = pos,
		.expr_types = new_array(0, 1, sizeof(v__table__Type)),
	}}, sizeof(v__ast__StringInterLiteral)), .typ = 160 /* v.ast.StringInterLiteral */};
	return node;
}
...
v__ast__ArrayInit v__parser__Parser_array_init(v__parser__Parser* p) {
	...
	v__token__Position last_pos = v__token__Token_position(&p->tok);
	int len = last_pos.pos - first_pos.pos;
	v__token__Position pos = (v__token__Position){
		.line_nr = first_pos.line_nr,
		.pos = first_pos.pos,
		.len = len,
...
v__ast__Expr v__parser__Parser_parse_number_literal(v__parser__Parser* p) {
	...
	if (string_index_any(lit, tos3(".eE")) >= 0) {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__FloatLiteral[]) {(v__ast__FloatLiteral){
			.val = lit,
		}}, sizeof(v__ast__FloatLiteral)), .typ = 134 /* v.ast.FloatLiteral */};
	} else {
		node = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__IntegerLiteral[]) {(v__ast__IntegerLiteral){
			.val = lit,
			.pos = pos,
		}}, sizeof(v__ast__IntegerLiteral)), .typ = 132 /* v.ast.IntegerLiteral */};
	}
	v__parser__Parser_next(p);
	return node;
}
...
v__ast__ConstDecl v__parser__Parser_const_decl(v__parser__Parser* p) {
	...
	while (p->tok.kind != v__token__Kind_rpar) {
		...
		v__ast__Scope_register(p->global_scope, field.name, /* sum type cast */ (v__ast__ScopeObject) {.obj = memdup(&(v__ast__ConstField[]) {field}, sizeof(v__ast__ConstField)), .typ = 187 /* v.ast.ConstField */});
	}
	v__parser__Parser_check(p, v__token__Kind_rpar);
...
v__ast__StructDecl v__parser__Parser_struct_decl(v__parser__Parser* p) {
	...
	v__table__TypeSymbol t = (v__table__TypeSymbol){
		...
		.is_union = is_union,
	}}, sizeof(v__table__Struct)), .typ = 80 /* v.table.Struct */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	};
	int ret = 0;
...
array_v__ast__Ident v__parser__Parser_parse_assign_lhs(v__parser__Parser* p) {
	...
	while (1) {
		...
		ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {(v__ast__IdentVar){
			...
			.typ = {0},
			.is_optional = 0,
		}}, sizeof(v__ast__IdentVar)), .typ = 200 /* v.ast.IdentVar */};
...
v__ast__Stmt v__parser__Parser_assign_stmt(v__parser__Parser* p) {
	...
	}}, sizeof(v__ast__AssignStmt)), .typ = 176 /* v.ast.AssignStmt */};
}
...
v__ast__GlobalDecl v__parser__Parser_global_decl(v__parser__Parser* p) {
	...
	v__ast__Scope_register(p->global_scope, name, /* sum type cast */ (v__ast__ScopeObject) {.obj = memdup(&(v__ast__GlobalDecl[]) {glob}, sizeof(v__ast__GlobalDecl)), .typ = 162 /* v.ast.GlobalDecl */});
	return glob;
}
...
v__ast__MatchExpr v__parser__Parser_match_expr(v__parser__Parser* p) {
	...
	while (1) {
		...
		if (p->tok.kind == v__token__Kind_key_else) {
			...
			v__ast__Expr expr = (v__ast__Expr){
			0};
			expr = /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Type[]) {x}, sizeof(v__ast__Type)), .typ = 157 /* v.ast.Type */};
			_PUSH(&exprs, (expr), tmp3, v__ast__Expr);
			v__ast__Scope_register(p->scope, tos3("it"), /* sum type cast */ (v__ast__ScopeObject) {.obj = memdup(&(v__ast__Var[]) {(v__ast__Var){
				.name = tos3("it"),
...
v__ast__EnumDecl v__parser__Parser_enum_decl(v__parser__Parser* p) {
	...
	v__parser__Parser_check(p, v__token__Kind_lcbr);
	array_string vals = new_array(0, 0, sizeof(string));
	array_v__ast__EnumField fields = new_array(0, 0, sizeof(v__ast__EnumField));
	while (p->tok.kind != v__token__Kind_eof && p->tok.kind != v__token__Kind_rcbr) {
		...
		_PUSH(&fields, ((v__ast__EnumField){
			.name = val,
			.pos = pos,
			.expr = expr,
			.has_expr = has_expr,
		}), tmp4, v__ast__EnumField);
		if (p->tok.kind == v__token__Kind_comma) {
			v__parser__Parser_next(p);
		}
	}
	...
	v__table__Table_register_type_symbol(p->table, (v__table__TypeSymbol){
		...
		.vals = vals,
	}}, sizeof(v__table__Enum)), .typ = 83 /* v.table.Enum */},
		.parent_idx = 0,
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
...
v__ast__TypeDecl v__parser__Parser_type_decl(v__parser__Parser* p) {
	...
	if (p->tok.kind == v__token__Kind_assign) {
		...
		}}, sizeof(v__table__SumType)), .typ = 84 /* v.table.SumType */},
			.parent_idx = 0,
			.methods = new_array(0, 1, sizeof(v__table__Fn)),
		});
		...
		}}, sizeof(v__ast__SumTypeDecl)), .typ = 126 /* v.ast.SumTypeDecl */};
	}
	if (p->tok.kind == v__token__Kind_key_fn) {
		...
		return /* sum type cast */ (v__ast__TypeDecl) {.obj = memdup(&(v__ast__FnTypeDecl[]) {(v__ast__FnTypeDecl){
			...
			.is_pub = is_pub,
			.typ = fn_type,
		}}, sizeof(v__ast__FnTypeDecl)), .typ = 127 /* v.ast.FnTypeDecl */};
	}
	...
	v__table__Table_register_type_symbol(p->table, (v__table__TypeSymbol){
		...
		.foo = tos3(""),
	}}, sizeof(v__table__Alias)), .typ = 82 /* v.table.Alias */},
		.methods = new_array(0, 1, sizeof(v__table__Fn)),
	});
	...
	}}, sizeof(v__ast__AliasTypeDecl)), .typ = 125 /* v.ast.AliasTypeDecl */};
}
...
v__table__Type v__checker__Checker_struct_init(v__checker__Checker* c, v__ast__StructInit* struct_init) {
	...
	if (typ_sym->kind == v__table__Kind_placeholder) {
		...
		data)[i];if (is_short_syntax && i >= info.fields.len) {
				break;
			}
			string field_name = (is_short_syntax ? (*(v__table__Field*)array_get(info.fields, i)).name : (*(string*)array_get(struct_init->fields, i)));
			if (_IN(string, field_name, inited_fields)) {
				v__checker__Checker_error(c, _STR("duplicate field name in struct literal: `%.*s`", field_name.len, field_name.str), struct_init->pos);
				continue;
			}
			_PUSH(&inited_fields, (field_name), tmp8, string);
			v__table__Field field = (is_short_syntax ? (*(v__table__Field*)array_get(info.fields, i)) : (v__table__Field){
					.name = tos3(""),
					.typ = {0},
					.default_val = tos3(""),
				});
			if (!is_short_syntax) {
				...
				// FOR IN
				for (int tmp11 = 0; tmp11 < info.fields.
				len; tmp11++) {	v__table__Field f = ((v__table__Field*)info.fields.
				data)[tmp11];if (string_eq(f.name, field_name)) {
						field = f;
						found_field = true;
						break;
					}
			...
			_PUSH(&struct_init->expr_types, (expr_type), tmp15, v__table__Type);
			_PUSH(&struct_init->expected_types, (field.typ), tmp16, v__table__Type);
		}
		// FOR IN
		for (int tmp17 = 0; tmp17 < info.fields.
		len; tmp17++) {	v__table__Field field = ((v__table__Field*)info.fields.
		data)[tmp17];if (_IN(string, field.name, inited_fields)) {
				continue;
			}
...
v__table__Type v__checker__Checker_infix_expr(v__checker__Checker* c, v__ast__InfixExpr* infix_expr) {
	...
	if (infix_expr->op == v__token__Kind_left_shift) {
		if (left->kind != v__table__Kind_array && !v__table__TypeSymbol_is_int(left)) {
			v__checker__Checker_error(c, _STR("cannot shift type %.*s into %.*s", right->name.len, right->name.str, left->name.len, left->name.str), v__checker__expr_pos(infix_expr->right));
			return _const_v__table__void_type;
		}
...
void v__checker__Checker_assign_expr(v__checker__Checker* c, v__ast__AssignExpr* assign_expr) {
	...
	if (!v__table__Table_check(c->table, right_type, left_type)) {
		...
		v__checker__Checker_error(c, _STR("cannot assign `%.*s` to variable `%.*s` of type `%.*s` ", right_type_sym->name.len, right_type_sym->name.str, v__ast__Expr_str(assign_expr->left).len, v__ast__Expr_str(assign_expr->left).str, left_type_sym->name.len, left_type_sym->name.str), v__checker__expr_pos(assign_expr->val));
	}
...
void v__checker__Checker_check_expr_opt_call(v__checker__Checker* c, v__ast__Expr x, v__table__Type xtype, bool is_return_used) {
	if (x.typ == 136 /* v.ast.CallExpr */) {
		v__ast__CallExpr* it = (v__ast__CallExpr*)x.obj; // ST it
		if (v__table__type_is(it->return_type, v__table__TypeFlag_optional)) {
...
void v__checker__Checker_check_or_block(v__checker__Checker* c, v__ast__CallExpr* call_expr, v__table__Type ret_type, bool is_ret_used) {
	if (!call_expr->or_block.is_used) {
		v__checker__Checker_error(c, _STR("%.*s() returns an option, but you missed to add an `or {}` block to it", call_expr->name.len, call_expr->name.str), call_expr->pos);
		return;
	}
	...
	if (is_ret_used) {
		if (!v__checker__Checker_is_last_or_block_stmt_valid(c, last_stmt)) {
			...
			v__checker__Checker_error(c, _STR("last statement in the `or {}` block should return ‘%.*s‘", expected_type_name.len, expected_type_name.str), call_expr->pos);
			return;
		}
		if (last_stmt.typ == 166 /* v.ast.ExprStmt */) {
			...
			string expected_type_name = v__table__Table_get_type_symbol(c->table, ret_type)->name;
			v__checker__Checker_error(c, _STR("wrong return type `%.*s` in the `or {}` block, expected `%.*s`", type_name.len, type_name.str, expected_type_name.len, expected_type_name.str), it->pos);
			return;
		}
		else if (last_stmt.typ == 174 /* v.ast.BranchStmt */) {
...
bool v__checker__Checker_is_last_or_block_stmt_valid(v__checker__Checker* c, v__ast__Stmt stmt) {
	return (stmt.typ == 163 /* v.ast.Return */) ? true : (stmt.typ == 174 /* v.ast.BranchStmt */) ? true : (stmt.typ == 166 /* v.ast.ExprStmt */) ? true : false;
}
...
void v__checker__Checker_enum_decl(v__checker__Checker* c, v__ast__EnumDecl decl) {
	// FOR IN
	for (int tmp1 = 0; tmp1 < decl.fields.
	len; tmp1++) {	v__ast__EnumField field = ((v__ast__EnumField*)decl.fields.
	data)[tmp1];if (field.has_expr) {
			if (field.expr.typ == 132 /* v.ast.IntegerLiteral */) {
				v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)field.expr.obj; // ST it
			}
			else if (field.expr.typ == 143 /* v.ast.PrefixExpr */) {
				v__ast__PrefixExpr* it = (v__ast__PrefixExpr*)field.expr.obj; // ST it
			}
			else {
				v__token__Position pos = v__checker__expr_pos(field.expr);
				if (pos.pos == 0) {
					pos = field.pos;
				}
...
void v__checker__Checker_assign_stmt(v__checker__Checker* c, v__ast__AssignStmt* assign_stmt) {
	...
	if (assign_stmt->left.len > assign_stmt->right.len) {
		if ((*(v__ast__Expr*)array_get(assign_stmt->right, 0)).typ == 136 /* v.ast.CallExpr */) {
		...
		if (right_type_sym->kind != v__table__Kind_multi_return) {
			v__checker__Checker_error(c, _STR("expression on the right does not return multiple values, while at least %d are expected", assign_stmt->left.len), assign_stmt->pos);
			return;
		}
		v__table__MultiReturn mr_info = v__table__TypeSymbol_mr_info(right_type_sym);
		if (mr_info.types.len < assign_stmt->left.len) {
			v__checker__Checker_error(c, _STR("right expression returns only %d values, but left one expects %d", mr_info.types.len, assign_stmt->left.len), assign_stmt->pos);
		}
		...
		data)[i];v__ast__Ident ident = (*(v__ast__Ident*)array_get(assign_stmt->left, i));
			...
			if (assign_stmt->op == v__token__Kind_assign) {
				v__table__Type var_type = v__checker__Checker_expr(c, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 135 /* v.ast.Ident */});
				_PUSH(&assign_stmt->left_types, (var_type), tmp7, v__table__Type);
			...
			ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {ident_var_info}, sizeof(v__ast__IdentVar)), .typ = 200 /* v.ast.IdentVar */};
			(*(v__ast__Ident*)array_get(assign_stmt->left, i)) = ident;
			_PUSH(&assign_stmt->right_types, (val_type), tmp9, v__table__Type);
		...
		data)[i];v__ast__Ident ident = (*(v__ast__Ident*)array_get(assign_stmt->left, i));
			...
			if (assign_stmt->op == v__token__Kind_assign) {
				v__table__Type var_type = v__checker__Checker_expr(c, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 135 /* v.ast.Ident */});
				_PUSH(&assign_stmt->left_types, (var_type), tmp13, v__table__Type);
				if (!v__table__Table_check(c->table, val_type, var_type)) {
					v__table__TypeSymbol* val_type_sym = v__table__Table_get_type_symbol(c->table, val_type);
					v__table__TypeSymbol* var_type_sym = v__table__Table_get_type_symbol(c->table, var_type);
					v__checker__Checker_error(c, _STR("assign stmt: cannot use `%.*s` as `%.*s`", val_type_sym->name.len, val_type_sym->name.str, var_type_sym->name.len, var_type_sym->name.str), assign_stmt->pos);
			...
			ident.info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentVar[]) {ident_var_info}, sizeof(v__ast__IdentVar)), .typ = 200 /* v.ast.IdentVar */};
			(*(v__ast__Ident*)array_get(assign_stmt->left, i)) = ident;
			_PUSH(&assign_stmt->right_types, (val_type), tmp15, v__table__Type);
			v__ast__Scope_update_var_type(scope, ident.name, val_type);
...
void v__checker__Checker_stmt(v__checker__Checker* c, v__ast__Stmt node) {
	if (node.typ == 182 /* v.ast.AssertStmt */) {
		...
		if (assert_type != _const_v__table__bool_type_idx) {
			...
			v__checker__Checker_error(c, _STR("assert can be used only with `bool` expressions, but found `%.*s` instead", atype_name.len, atype_name.str), it->pos);
		}
	}
	else if (node.typ == 176 /* v.ast.AssignStmt */) {
		v__ast__AssignStmt* it = (v__ast__AssignStmt*)node.obj; // ST it
		v__checker__Checker_assign_stmt(c, it);
	}
	else if (node.typ == 185 /* v.ast.Block */) {
		...
		if (c->in_for_count == 0) {
			v__checker__Checker_error(c, _STR("%.*s statement not within a loop", it->tok.lit.len, it->tok.lit.str), v__token__Token_position(&it->tok));
		}
	}
	else if (node.typ == 171 /* v.ast.CompIf */) {
	...
	else if (node.typ == 172 /* v.ast.ConstDecl */) {
		...
		data)[i];_PUSH(&field_names, (field.name), tmp5, string);
			_PUSH(&field_order, (i), tmp6, int);
		}
		...
		data)[i];c->const_decl = field.name;
			_PUSH(&c->const_deps, (field.name), tmp7, string);
			v__table__Type typ = v__checker__Checker_expr(c, field.expr);
			(*(v__ast__ConstField*)array_get(it->fields, i)).typ = typ;
			// FOR IN
			for (int tmp8 = 0; tmp8 < c->const_deps.
			len; tmp8++) {	string cd = ((string*)c->const_deps.
			data)[tmp8];// FOR IN
			...
			_PUSH(&done_fields, (i), tmp10, int);
			c->const_deps = new_array(0, 0, sizeof(string));
		}
		if (needs_order) {
			array_v__ast__ConstField ordered_fields = new_array(0, 0, sizeof(v__ast__ConstField));
			// FOR IN
			for (int tmp12 = 0; tmp12 < field_order.
			len; tmp12++) {	int order = ((int*)field_order.
			data)[tmp12];_PUSH(&ordered_fields, ((*(v__ast__ConstField*)array_get(it->fields, order))), tmp13, v__ast__ConstField);
			}
			it->fields = ordered_fields;
		}
	}
	else if (node.typ == 178 /* v.ast.DeferStmt */) {
		v__ast__DeferStmt* it = (v__ast__DeferStmt*)node.obj; // ST it
		v__checker__Checker_stmts(c, it->stmts);
	}
	else if (node.typ == 177 /* v.ast.EnumDecl */) {
	...
	else if (node.typ == 169 /* v.ast.ForCStmt */) {
	...
	else if (node.typ == 170 /* v.ast.ForInStmt */) {
	...
	else if (node.typ == 184 /* v.ast.GoStmt */) {
...
v__table__Type v__checker__Checker_expr(v__checker__Checker* c, v__ast__Expr node) {
	...
	else if (node.typ == 137 /* v.ast.BoolLiteral */) {
		v__ast__BoolLiteral* it = (v__ast__BoolLiteral*)node.obj; // ST it
		return _const_v__table__bool_type;
	}
	else if (node.typ == 147 /* v.ast.CastExpr */) {
	...
	else if (node.typ == 160 /* v.ast.StringInterLiteral */) {
...
v__token__Position v__checker__expr_pos(v__ast__Expr node) {
	if (node.typ == 139 /* v.ast.ArrayInit */) {
		...
		v__ast__InfixExpr* it = (v__ast__InfixExpr*)node.obj; // ST it
		v__token__Position left_pos = v__checker__expr_pos(it->left);
		v__token__Position right_pos = v__checker__expr_pos(it->right);
...
v__table__Type v__checker__Checker_ident(v__checker__Checker* c, v__ast__Ident* ident) {
	if (string_eq(ident->name, c->var_decl_name)) {
		v__checker__Checker_error(c, _STR("unresolved: `%.*s`", ident->name.len, ident->name.str), ident->pos);
		return _const_v__table__void_type;
	}
	if (c->const_deps.len > 0) {
		...
		_PUSH(&c->const_deps, (name), tmp5, string);
	}
	...
	if (ident->kind == v__ast__IdentKind_variable) {
		...
		if ((tmp13 = obj.ok)) {
			if (/*opt*/(*(v__ast__ScopeObject*)obj.data).typ == 162 /* v.ast.GlobalDecl */) {
			...
			else if (/*opt*/(*(v__ast__ScopeObject*)obj.data).typ == 187 /* v.ast.ConstField */) {
		...
		if ((tmp16 = func.ok)) {
			...
			ident->info = /* sum type cast */ (v__ast__IdentInfo) {.obj = memdup(&(v__ast__IdentFn[]) {(v__ast__IdentFn){
				.typ = fn_type,
			}}, sizeof(v__ast__IdentFn)), .typ = 199 /* v.ast.IdentFn */};
			return fn_type;
		}}
	}
	if (ident->is_c) {
...
v__table__Type v__checker__Checker_match_expr(v__checker__Checker* c, v__ast__MatchExpr* node) {
	...
	data)[tmp2];// FOR IN
		...
		if (branch.stmts.len > 0) {
			if ((*(v__ast__Stmt*)array_get(branch.stmts, branch.stmts.len - 1)).typ == 166 /* v.ast.ExprStmt */) {
...
v__table__Type v__checker__Checker_if_expr(v__checker__Checker* c, v__ast__IfExpr* node) {
	...
	data)[i];if (branch.cond.typ == 154 /* v.ast.ParExpr */) {
	...
	if (node->has_else && node->is_expr) {
		...
		if (last_branch.stmts.len > 0) {
			if ((*(v__ast__Stmt*)array_get(last_branch.stmts, last_branch.stmts.len - 1)).typ == 166 /* v.ast.ExprStmt */) {
...
v__table__Type v__checker__Checker_index_expr(v__checker__Checker* c, v__ast__IndexExpr* node) {
	...
	node->left_type = typ;
	bool is_range = false;
	if (node->index.typ == 145 /* v.ast.RangeExpr */) {
...
void v__checker__Checker_warn_or_error(v__checker__Checker* c, string s, v__token__Position pos, bool warn) {
	...
	string kind = (c->pref->is_verbose ? _STR("checker %.*s #%d:", typ.len, typ.str, c->nr_errors) : _STR("%.*s:", typ.len, typ.str));
	string ferror = v__util__formatted_error(kind, s, c->file.path, pos);
...
string v__gen__cgen(array_v__ast__File files, v__table__Table* table, v__pref__Preferences* pref) {
	...
	v__gen__Gen g = (v__gen__Gen){
		...
		.array_fn_definitions = new_array(0, 1, sizeof(string)),
	};
	v__gen__Gen_init(&g);
	...
	return string_add(string_add(string_add(string_add(string_add(string_add(string_add(v__gen__Gen_hashes(g), strings__Builder_str(&g.includes)), strings__Builder_str(&g.typedefs)), strings__Builder_str(&g.typedefs2)), strings__Builder_str(&g.definitions)), strings__Builder_str(&g.gowrappers)), strings__Builder_str(&g.stringliterals)), strings__Builder_str(&g.out));
}
...
string v__gen__Gen_typ(v__gen__Gen* g, v__table__Type t) {
	...
	if (v__table__type_is(t, v__table__TypeFlag_optional)) {
		...
		if (!(_IN(string, styp, g->optionals))) {
			strings__Builder_writeln(&g->typedefs2, _STR("typedef Option %.*s;", styp.len, styp.str));
...
void v__gen__Gen_stmt(v__gen__Gen* g, v__ast__Stmt node) {
	...
	if (node.typ == 182 /* v.ast.AssertStmt */) {
	...
	else if (node.typ == 173 /* v.ast.Attr */) {
		v__ast__Attr* it = (v__ast__Attr*)node.obj; // ST it
		if (string_eq(it->name, tos3("inline"))) {
			v__gen__Gen_writeln(g, it->name);
		} else {
		...
		_PUSH(&g->defer_stmts, (defer_stmt), tmp3, v__ast__DeferStmt);
	}
	else if (node.typ == 177 /* v.ast.EnumDecl */) {
		v__ast__EnumDecl* it = (v__ast__EnumDecl*)node.obj; // ST it
	...
	else if (node.typ == 162 /* v.ast.GlobalDecl */) {
	...
	else if (node.typ == 168 /* v.ast.StructDecl */) {
		...
		if (it->is_union) {
			strings__Builder_writeln(&g->typedefs, _STR("typedef union %.*s %.*s;", name.len, name.str, name.len, name.str));
		} else {
			strings__Builder_writeln(&g->typedefs, _STR("typedef struct %.*s %.*s;", name.len, name.str, name.len, name.str));
		}
	}
	else if (node.typ == 128 /* v.ast.TypeDecl */) {
		...
		v__gen__verror(string_add(tos3("cgen.stmt(): unhandled node "), tos3( /* v.ast.Stmt */ v_typeof_sumtype_104( (node).typ ))));
	}
	;
}
...
void v__gen__Gen_gen_assign_stmt(v__gen__Gen* g, v__ast__AssignStmt assign_stmt) {
	...
	if (assign_stmt.left.len > assign_stmt.right.len) {
		...
		data)[i];if (ident.kind == v__ast__IdentKind_blank_ident) {
			...
			v__gen__Gen_expr(g, /* sum type cast */ (v__ast__Expr) {.obj = memdup(&(v__ast__Ident[]) {ident}, sizeof(v__ast__Ident)), .typ = 135 /* v.ast.Ident */});
			if (is_optional) {
...
bool v__gen__Gen_gen_clone_assignment(v__gen__Gen* g, v__ast__Expr val, v__table__TypeSymbol right_sym, bool add_eq) {
	bool is_ident = false;
	if (val.typ == 135 /* v.ast.Ident */) {
		v__ast__Ident* it = (v__ast__Ident*)val.obj; // ST it
		is_ident = true;
	}
	else if (val.typ == 140 /* v.ast.SelectorExpr */) {
	...
	for (int tmp2 = 0; tmp2 < keys_tmp1.len; tmp2++) {
		...
		if (obj.typ == 188 /* v.ast.Var */) {
			...
			if (sym->kind == v__table__Kind_string && !is_optional) {
				string t = tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (var.expr).typ ));
				if (var.expr.typ == 131 /* v.ast.StringLiteral */) {
	...
	if (node.typ == 139 /* v.ast.ArrayInit */) {
		...
		if (type_sym->kind != v__table__Kind_array_fixed) {
			...
			if (it->exprs.len == 0) {
				...
				v__gen__Gen_write(g, _STR("(%.*s[%d]){\n\t\t", elem_type_str.len, elem_type_str.str, len));
				// FOR IN
		...
		println(term__red(string_add(tos3("cgen.expr(): bad node "), tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (node).typ )))));
	}
	;
}
...
void v__gen__Gen_assign_expr(v__gen__Gen* g, v__ast__AssignExpr node) {
	...
	array_v__ast__Stmt or_stmts = new_array(0, 0, sizeof(v__ast__Stmt));
	v__table__Type return_type = _const_v__table__void_type;
	if (node.val.typ == 136 /* v.ast.CallExpr */) {
...
void v__gen__Gen_infix_expr(v__gen__Gen* g, v__ast__InfixExpr node) {
	...
	if (node.left_type == _const_v__table__string_type_idx && node.op != v__token__Kind_key_in) {
		...
		if (node.op == v__token__Kind_eq) {
			v__gen__Gen_write(g, _STR("%.*s_arr_eq(", ptr_typ.len, ptr_typ.str));
...
void v__gen__Gen_match_expr(v__gen__Gen* g, v__ast__MatchExpr node) {
	...
	data)[j];if (j == node.branches.len - 1) {
		...
		if (node.is_sum_type && branch.exprs.len > 0 && !node.is_expr) {
			...
			if (first_expr.typ == 157 /* v.ast.Type */) {
...
void v__gen__Gen_ident(v__gen__Gen* g, v__ast__Ident node) {
	...
	if (node.info.typ == 200 /* v.ast.IdentVar */) {
...
void v__gen__Gen_if_expr(v__gen__Gen* g, v__ast__IfExpr node) {
	...
	if (node.is_expr && node.branches.len >= 2 && node.has_else && type_sym->kind != v__table__Kind_void) {
		...
		len; i++) {	v__ast__IfBranch branch = ((v__ast__IfBranch*)node.branches.
		data)[i];if (i == 0) {
				if (branch.cond.typ == 153 /* v.ast.IfGuardExpr */) {
...
void v__gen__Gen_index_expr(v__gen__Gen* g, v__ast__IndexExpr node) {
	...
	if (!is_range) {
		...
		if (v__table__type_is(node.left_type, v__table__TypeFlag_variadic)) {
			...
			if (node.left.typ == 140 /* v.ast.SelectorExpr */) {
...
void v__gen__Gen_return_statement(v__gen__Gen* g, v__ast__Return node) {
	...
	if (node.exprs.len > 1) {
		...
		if (fn_return_is_optional && !v__table__type_is((*(v__table__Type*)array_get(node.types, 0)), v__table__TypeFlag_optional) && string_ne(return_sym->name, tos3("Option"))) {
			bool is_none = false;
			bool is_error = false;
			v__ast__Expr expr0 = (*(v__ast__Expr*)array_get(node.exprs, 0));
			if (expr0.typ == 151 /* v.ast.None */) {
				v__ast__None* it = (v__ast__None*)expr0.obj; // ST it
				is_none = true;
			}
			else if (expr0.typ == 136 /* v.ast.CallExpr */) {
				v__ast__CallExpr* it = (v__ast__CallExpr*)expr0.obj; // ST it
				if (string_eq(it->name, tos3("error"))) {
					is_error = true;
				}
			}
			else {
...
void v__gen__Gen_struct_init(v__gen__Gen* g, v__ast__StructInit it) {
	...
	if (is_struct) {
		...
		data)[tmp8];if (_IN(string, field.name, inited_fields)) {
			...
			if (v__table__type_is(field.typ, v__table__TypeFlag_optional)) {
				continue;
			}
			string field_name = v__gen__c_name(field.name);
			string zero = (string_ne(field.default_val, tos3("")) ? field.default_val : v__gen__Gen_type_default(/*rec*/*g, field.typ));
...
void v__gen__Gen_generate_array_equality_fn(v__gen__Gen* g, string ptr_typ, v__table__Type styp, v__table__TypeSymbol* sym) {
	_PUSH(&g->array_fn_definitions, (ptr_typ), tmp1, string);
	strings__Builder_writeln(&g->definitions, _STR("bool %.*s_arr_eq(array_%.*s a, array_%.*s b) {", ptr_typ.len, ptr_typ.str, ptr_typ.len, ptr_typ.str, ptr_typ.len, ptr_typ.str));
...
void v__gen__Gen_write_types(v__gen__Gen* g, array_v__table__TypeSymbol types) {
	...
	data)[tmp1];if (string_starts_with(typ.name, tos3("C."))) {
		...
		string name = string_replace(typ.name, tos3("."), tos3("__"));
		if (typ.info.typ == 80 /* v.table.Struct */) {
			v__table__Struct* it = (v__table__Struct*)typ.info.obj; // ST it
			v__table__Struct info = /* as */ *(v__table__Struct*)typ.info.obj;
			if (info.is_union) {
				strings__Builder_writeln(&g->definitions, _STR("union %.*s {", name.len, name.str));
			} else {
				strings__Builder_writeln(&g->definitions, _STR("struct %.*s {", name.len, name.str));
			}
			if (info.fields.len > 0) {
				// FOR IN
				for (int tmp6 = 0; tmp6 < info.fields.
				len; tmp6++) {	v__table__Field field = ((v__table__Field*)info.fields.
				data)[tmp6];string type_name = v__gen__Gen_typ(g, field.typ);
					string field_name = v__gen__c_name(field.name);
		...
		else if (typ.info.typ == 82 /* v.table.Alias */) {
			v__table__Alias* it = (v__table__Alias*)typ.info.obj; // ST it
		}
		else if (typ.info.typ == 84 /* v.table.SumType */) {
		...
		else if (typ.info.typ == 78 /* v.table.ArrayFixed */) {
...
array_v__table__TypeSymbol v__gen__Gen_sort_structs(v__gen__Gen g, array_v__table__TypeSymbol typesa) {
	...
	data)[tmp3];array_string field_deps = new_array(0, 0, sizeof(string));
		...
		else if (t.info.typ == 80 /* v.table.Struct */) {
...
void v__gen__Gen_string_inter_literal(v__gen__Gen* g, v__ast__StringInterLiteral node) {
	...
	data)[i];string escaped_val = string_replace_each(val, new_array_from_c_array(6, 6, sizeof(string), (string[6]){
		...
		} else if (((*(v__table__Type*)array_get(node.expr_types, i)) == _const_v__table__string_type || (*(v__table__Type*)array_get(node.expr_types, i)) == _const_v__table__bool_type) || sym->kind == v__table__Kind_enum_) {
			v__gen__Gen_write(g, tos3("%.*s"));
		} else {
			if ((*(v__ast__Expr*)array_get(node.exprs, i)).typ == 148 /* v.ast.EnumVal */) {
				v__ast__EnumVal* it = (v__ast__EnumVal*)(*(v__ast__Expr*)array_get(node.exprs, i)).obj; // ST it
				v__gen__Gen_write(g, tos3("%.*s"));
			}
			else {
				v__gen__Gen_write(g, tos3("%d"));
	...
	data)[i];string sfmt = (*(string*)array_get(node.expr_fmts, i));
		if (sfmt.len > 0) {
			...
			v__gen__Gen_expr(g, expr);
			v__gen__Gen_write(g, tos3(" ? 4 : 5, "));
			v__gen__Gen_expr(g, expr);
			v__gen__Gen_write(g, tos3(" ? \"true\" : \"false\""));
		} else {
			v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, (*(v__table__Type*)array_get(node.expr_types, i)));
			if (sym->kind == v__table__Kind_enum_) {
				bool is_var = ((*(v__ast__Expr*)array_get(node.exprs, i)).typ == 140 /* v.ast.SelectorExpr */) ? true : ((*(v__ast__Expr*)array_get(node.exprs, i)).typ == 135 /* v.ast.Ident */) ? true : false;
				if (is_var) {
...
void v__gen__Gen_fn_call(v__gen__Gen* g, v__ast__CallExpr node) {
	...
	if (is_print && (*(v__ast__CallArg*)array_get(node.args, 0)).typ != _const_v__table__string_type) {
		...
		if (g->autofree && !v__table__type_is(typ, v__table__TypeFlag_optional)) {
			...
			bool is_var = (expr.typ == 140 /* v.ast.SelectorExpr */) ? true : (expr.typ == 135 /* v.ast.Ident */) ? true : false;
...
multi_return_string_string v__gen__Gen_type_of_last_statement(v__gen__Gen* g, array_v__ast__Stmt stmts) {
	...
	if (stmts.len > 0) {
		...
		last_type = tos3( /* v.ast.Stmt */ v_typeof_sumtype_104( (last_stmt).typ ));
		if (string_eq(last_type, tos3("v.ast.ExprStmt"))) {
			if (last_stmt.typ == 166 /* v.ast.ExprStmt */) {
				v__ast__ExprStmt* it = (v__ast__ExprStmt*)last_stmt.obj; // ST it
				string it_expr_type = tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (it->expr).typ ));
...
string v__gen__Gen_type_of_call_expr(v__gen__Gen* g, v__ast__Expr node) {
	if (node.typ == 136 /* v.ast.CallExpr */) {
		v__ast__CallExpr* it = (v__ast__CallExpr*)node.obj; // ST it
		return v__gen__Gen_typ(g, it->return_type);
	}
	else {
		return tos3( /* v.ast.Expr */ v_typeof_sumtype_161( (node).typ ));
	}
	;
	return tos3("");
}
...
void v__gen__Gen_go_stmt(v__gen__Gen* g, v__ast__GoStmt node) {
	string tmp = v__gen__Gen_new_tmp_var(g);
	if (node.call_expr.typ == 136 /* v.ast.CallExpr */) {
...
void v__gen__Gen_gen_str_for_type(v__gen__Gen* g, v__table__TypeSymbol sym, string styp) {
	...
	_PUSH(&g->str_types, (styp), tmp2, string);
	if (sym.info.typ == 80 /* v.table.Struct */) {
		v__table__Struct* it = (v__table__Struct*)sym.info.obj; // ST it
		v__gen__Gen_gen_str_for_struct(g, */*d*/it, styp);
	}
		...
		println(_STR("cannot generate str() for %.*s", sym.name.len, sym.name.str));
	}
	;
}
...
void v__gen__Gen_gen_str_for_enum(v__gen__Gen* g, v__table__Enum info, string styp) {
	...
	strings__Builder_write(&g->definitions, _STR("string %.*s_str(%.*s it) {\n\tswitch(it) {\n", s.len, s.str, styp.len, styp.str));
	// FOR IN
	for (int i = 0; i < info.vals.
	len; i++) {	string val = ((string*)info.vals.
	data)[i];strings__Builder_write(&g->definitions, _STR("\t\tcase %.*s_%.*s: return tos3(\"%.*s\");\n", s.len, s.str, val.len, val.str, val.len, val.str));
	}
	strings__Builder_write(&g->definitions, tos3("\t\tdefault: return tos3(\"unknown enum value\"); } }\n"));
}
...
void v__gen__Gen_gen_str_for_struct(v__gen__Gen* g, v__table__Struct info, string styp) {
	...
	data)[i];v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, field.typ);
		if (sym->kind == v__table__Kind_struct_) {
	...
	string s = string_replace(styp, tos3("."), tos3("__"));
	strings__Builder_write(&g->definitions, _STR("string %.*s_str(%.*s it, int indent_count) {\n", s.len, s.str, styp.len, styp.str));
	strings__Builder_write(&g->definitions, tos3("\tstring indents = tos3(\"\");\n\tfor (int i = 0; i < indent_count; i++) { indents = string_add(indents, tos3(\"    \")); }\n"));
	strings__Builder_write(&g->definitions, _STR("\treturn _STR(\"%.*s {\\n", styp.len, styp.str));
	// FOR IN
	for (int tmp2 = 0; tmp2 < info.fields.
	len; tmp2++) {	v__table__Field field = ((v__table__Field*)info.fields.
	data)[tmp2];string fmt = v__gen__Gen_type_to_fmt(/*rec*/*g, field.typ);
		strings__Builder_write(&g->definitions, string_add(tos3("%.*s    "), _STR("%.*s: %.*s\\n", field.name.len, field.name.str, fmt.len, fmt.str)));
	}
	strings__Builder_write(&g->definitions, tos3("%.*s}\""));
	if (info.fields.len > 0) {
		strings__Builder_write(&g->definitions, tos3(", "));
		// FOR IN
		for (int i = 0; i < info.fields.
		...
		data)[i];v__table__TypeSymbol* sym = v__table__Table_get_type_symbol(g->table, field.typ);
			if (sym->kind == v__table__Kind_struct_) {
				string field_styp = v__gen__Gen_typ(g, field.typ);
				strings__Builder_write(&g->definitions, _STR("indents.len, indents.str, %.*s_str(it.%.*s, indent_count + 1).len, %.*s_str(it.%.*s, indent_count + 1).str", field_styp.len, field_styp.str, field.name.len, field.name.str, field_styp.len, field_styp.str, field.name.len, field.name.str));
			} else {
				strings__Builder_write(&g->definitions, _STR("indents.len, indents.str, it.%.*s", field.name.len, field.name.str));
				if (field.typ == _const_v__table__string_type) {
					strings__Builder_write(&g->definitions, _STR(".len, it.%.*s.str", field.name.len, field.name.str));
				} else if (field.typ == _const_v__table__bool_type) {
					strings__Builder_write(&g->definitions, _STR(" ? 4 : 5, it.%.*s ? \"true\" : \"false\"", field.name.len, field.name.str));
				}
...
void v__gen__JsGen_expr(v__gen__JsGen* g, v__ast__Expr node) {
	if (node.typ == 132 /* v.ast.IntegerLiteral */) {
		v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)node.obj; // ST it
...
void v__gen__x64__Gen_inc(v__gen__x64__Gen* g, v__gen__x64__Register reg) {
	...
	if (reg == v__gen__x64__Register_r12) {
		...
		v_panic(_STR("unhandled inc %.*s", v__gen__x64__Register_str(reg).len, v__gen__x64__Register_str(reg).str));
	}
	;
}
...
void v__gen__x64__Gen_gen_print_from_expr(v__gen__x64__Gen* g, v__ast__Expr expr, bool newline) {
	if (expr.typ == 131 /* v.ast.StringLiteral */) {
...
void v__gen__x64__Gen_stmt(v__gen__x64__Gen* g, v__ast__Stmt node) {
	if (node.typ == 172 /* v.ast.ConstDecl */) {
		v__ast__ConstDecl* it = (v__ast__ConstDecl*)node.obj; // ST it
	}
	else if (node.typ == 107 /* v.ast.FnDecl */) {
		v__ast__FnDecl* it = (v__ast__FnDecl*)node.obj; // ST it
...
void v__gen__x64__Gen_expr(v__gen__x64__Gen* g, v__ast__Expr node) {
	if (node.typ == 142 /* v.ast.AssignExpr */) {
		v__ast__AssignExpr* it = (v__ast__AssignExpr*)node.obj; // ST it
	}
	else if (node.typ == 132 /* v.ast.IntegerLiteral */) {
		v__ast__IntegerLiteral* it = (v__ast__IntegerLiteral*)node.obj; // ST it
	...
	else if (node.typ == 139 /* v.ast.ArrayInit */) {
		v__ast__ArrayInit* it = (v__ast__ArrayInit*)node.obj; // ST it
	}
	else if (node.typ == 135 /* v.ast.Ident */) {
		v__ast__Ident* it = (v__ast__Ident*)node.obj; // ST it
...
string benchmark__Benchmark_total_message(benchmark__Benchmark* b, string msg) {
	string tmsg = string_add(string_add(string_add(string_add(string_add(string_add(string_add(_STR("%.*s\n                 ok, fail, skip, total = ", msg.len, msg.str), term__ok_message(_STR("%5d", b->nok))), tos3(", ")), (b->nfail > 0 ? term__red(_STR("%5d", b->nfail)) : _STR("%5d", b->nfail))), tos3(", ")), (b->nskip > 0 ? term__bright_yellow(_STR("%5d", b->nskip)) : _STR("%5d", b->nskip))), tos3(", ")), _STR("%5d", b->ntotal));
	if (b->verbose) {
...
v__token__Token v__scanner__Scanner_scan(v__scanner__Scanner* s) {
	...
	if (c == '+') {
		...
		if (string_eq(name, tos3("VEXE"))) {
			string vexe = v__pref__vexe_path();
			return v__scanner__Scanner_new_token(s, v__token__Kind_string, v__scanner__cescaped_path(vexe), 5);
		}
		if (string_eq(name, tos3("FILE"))) {
			return v__scanner__Scanner_new_token(s, v__token__Kind_string, v__scanner__cescaped_path(os__real_path(s->file_path)), 5);
		}
